        ...
        <div className="flex items-center gap-6">
          {user ? (
            ...
            >
              ...
              {/* DROPDOWN MENU (Твой оригинальный стиль) */}
              <div
                className={`absolute right-[-16px] top-[64px] w-56 bg-white text-[#002f34] rounded-sm shadow-xl border border-gray-100 overflow-hidden transition-all duration-200 
              ...
              >
                ...
                <div className="flex flex-col py-1">
                  ...
                  <div onClick={() => navigate("/myprofile")} className="px-4 py-1.5 hover:bg-emerald-950 hover:text-white cursor-pointer transition-colors text-[14px]">
                    Your ads
                  </div>
                  <div onClick={() => navigate("/setting")} className="px-4 py-1.5 hover:bg-emerald-950 hover:text-white cursor-pointer transition-colors text-[14px]">
                    Settings
                  </div>
                  ...
                  <div 
                    onClick={() => navigate("/favorites")} // Добавляем навигацию
                    className="px-4 py-1.5 hover:bg-emerald-950 hover:text-white cursor-pointer transition-colors text-[14px] flex justify-between items-center group"
                  >
                    <span>Ads</span>
                    {/* Если хочешь динамический счетчик, нужно будет передавать его из стейта, 
                        но пока оставим структуру */}
                    <span className="bg-gray-100 px-2 py-0.5 rounded-full text-[10px] text-gray-500 group-hover:bg-emerald-800 group-hover:text-white">
                      {/* Тут можно вывести favorites.length если прокинуть данные */}
                      View
                    </span>
                  </div>
                  ...
                  <div onClick={logout} className="px-4 py-1.5 hover:bg-emerald-950 hover:text-white cursor-pointer transition-colors text-[14px]">
                    Logout
                  </div>
                </div>
              </div>
