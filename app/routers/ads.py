...
from app.schemas.ad_schemas import AdCreate, AdResponse, AdFullResponse, AdUpdate
from app.services.ad_service import service_create_ad, service_get_ads, service_update_ad, service_delete_ad
...
@handle_ads_errors
def get_ads(user = Depends(get_current_user), db: Session = Depends(get_db)):
    return service_get_ads(user, db)
